...
public class Config {
    ...
    public static String MASTER_IP = "172.16.1.66";
    public static String[] WORKER_IP = {"172.16.1.66", "172.16.1.66", "172.16.1.66"};
    public static String REDUCER_IP = "172.16.1.66";
