...
public class Config {
    ...
    public static String MASTER_IP = "192.168.1.20";
    public static String[] WORKER_IP = {"192.168.1.20", "192.168.1.20", "192.168.1.20"};
    public static String REDUCER_IP = "192.168.1.20";
